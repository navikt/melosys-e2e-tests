...
test.describe('EU/EØS Trygdeavgift - Pensjonist årsavregning med avvik', () => {
  test('skal fullføre pensjonistbehandling og årsavregning med innbetalt avvik', async ({ page }) => {
    ...
    // Step 6: Åpne årsavregning og fullfør avviksflyten til vedtak
    ...
    await aarsavregning.fyllInnInnbetaltTrygdeavgift('300');
    await aarsavregning.velgSkattepliktig(false);
    await aarsavregning.velgInntektskilde('PENSJON');
    await aarsavregning.fyllInnBruttoinntektMedApiVent('23313');
